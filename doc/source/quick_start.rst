...
This section provides a quick start into the MULTIPLY Data Access.

.. by demonstrating how a particular climate use case
is performed.

To begin, see the :doc:`installation` for installing the MULTIPLY Data Access Component.

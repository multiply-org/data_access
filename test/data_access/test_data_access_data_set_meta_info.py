...
def test_meta_info_provider_equals():
    data_set_meta_info = DataSetMetaInfo(coverage="POLYGON((10 10, 20 10, 20 20, 10 20, 10 10))",
                                         ...
                                         data_type="TYPE_D",
                                         identifier="ctfgb")
    other_coverage = DataSetMetaInfo(coverage="POLYGON((15 15, 25 15, 25 25, 15 25, 15 15))",
                                     start_time="2017-03-21 14:33:00",
                                     end_time="2017-03-21 14:45:00",
                                     data_type="TYPE_D",
                                     identifier="dterftge")
    ...
    other_data_type = DataSetMetaInfo(coverage="POLYGON((15 15, 25 15, 25 25, 15 25, 15 15))",
                                      ...
                                      data_type="TYPE_A",
                                      identifier="drtwr")
    equal_except_for_id = DataSetMetaInfo(coverage="POLYGON((10 10, 20 10, 20 20, 10 20, 10 10))",
                                          start_time="2017-03-21 14:33:00",
                                          end_time="2017-03-21 14:45:00",
                                          data_type="TYPE_D",
                                          identifier="tfgtzz")

...
print(emus)
# data_access_component.get_data_urls(BARRAX_POLYGON, start_time, end_time, 'ISO_MSI_A_EMU')
# data_access_component.get_data_urls(BARRAX_POLYGON, start_time, end_time, 'ISO_MSI_B_EMU')
